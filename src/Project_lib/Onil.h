...
#ifndef CMAKE_SFML_PROJECT_MASTER_ONIL_H
#define CMAKE_SFML_PROJECT_MASTER_ONIL_H

#include "Enemy.h"

class Onil : public Enemy {
public:
    Onil(sf::Texture &SpriteSheet,short int X, short int Y, int Name ,float ScaleFactor) : Enemy(SpriteSheet,X,Y,6,ScaleFactor){}
    ...
    void setState(int s) override {
        ...
        if (s == 0){
            ...
            EntityRect.left = 7*16;
            EntityRect.top = 16*18;
        }
    }
...
#endif //CMAKE_SFML_PROJECT_MASTER_ONIL_H
